...
void PrintFooter( vector < double >& vval )
{
  ...
  cout << "  | " 
       << "Entry     : " 
       << setw( width - 4 - 12 ) << setprecision(4) << vval.size() 
       << " |"
       << endl;
  cout << "  | " 
       << "Mean      : " 
       << setw( width - 4 - 12 ) << setprecision(4) << GetMean( vval )
       << " |"
       << endl;
  cout << "  | " 
       << "Std. Dev. : " 
       << setw( width - 4 - 12) << setprecision(4) << GetStdDev( vval )
       << " |"
       << endl;
  cout << "  | " 
       << "Max       : " 
       << setw( width - 4 - 12) << setprecision(4) << *max_element( vval.begin(), vval.end() )
       << " |"
       << endl;
  cout << "  | " 
       << "Min       : " 
